 ...
 */
export const getAdditionalContext = tool({
  description:
    "Retrieve additional contextual information from the knowledge base by querying a specific collection with a semantic search query. Use this when you need more information about a topic that might be stored in the document collections.",
  inputSchema: z.object({
    ...
    collectionName: z
      .string()
      .describe(
        "The name of the ChromaDB collection to query (e.g., 'documents', 'company-docs')"
      ),
  }),
